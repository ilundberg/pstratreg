...
\begin{verbatim}
#>            x     a     s          y
#> 1 -0.3995057  TRUE  TRUE  1.7729094
#> 2 -0.5056109  TRUE  TRUE -0.9123792
#> 3  2.1129859  TRUE  TRUE  3.7708568
#> 4 -0.9167857 FALSE FALSE         NA
#> 5 -0.7186774 FALSE FALSE         NA
\end{verbatim}
...
\NormalTok{)}
\CommentTok{\#\textgreater{} Warning in pstratreg(formula\_y = formula(y \textasciitilde{} x * a), formula\_s = formula(s \textasciitilde{} : Monotonicity violated in 62 \% of cases}
...
\NormalTok{)}
\CommentTok{\#\textgreater{} Warning in pstratreg(formula\_y = formula(y \textasciitilde{} x * a), formula\_s = formula(s \textasciitilde{} : Monotonicity violated in 38 \% of cases}
\CommentTok{\#\textgreater{} Forcing s1\_trunc = s0\_trunc at midpoint of estimates for those}
\end{Highlighting}
\end{Shaded}
...
#> 1 -0.39950575  TRUE  TRUE  1.7729094  FALSE  FALSE
#> 2 -0.50561090  TRUE  TRUE -0.9123792   TRUE  FALSE
#> 3  2.11298587  TRUE  TRUE  3.7708568  FALSE   TRUE
#> 4 -0.91678566 FALSE FALSE         NA   TRUE  FALSE
#> 5 -0.71867737 FALSE FALSE         NA   TRUE  FALSE
#> 6 -0.04953687 FALSE FALSE         NA  FALSE  FALSE
\end{verbatim}
...
#>   <lgl>  <lgl>  <dbl> <dbl>    <dbl>
#> 1 FALSE  FALSE  0.869 0.863 -0.00610
#> 2 FALSE  TRUE   0.959 0.951 -0.00793
#> 3 TRUE   FALSE  0.624 0.645  0.0212 
#> 
#> Effect on outcome among those who would have a valid outcome regardless of treatment
#> # A tibble: 3 x 4
...
#>   <lgl>  <lgl>           <dbl>          <dbl>
#> 1 FALSE  FALSE           0.668           1.75
#> 2 TRUE   FALSE          -1.35            3.40
#> 3 FALSE  TRUE            1.21            1.60
\end{verbatim}
...
#>   <chr>             <dbl> <dbl>  <dbl>  <dbl>
#> 1 effect_y_lower -0.00492 0.388 -0.766  0.756
#> 2 effect_y_upper  2.14    0.397  1.36   2.92
\end{verbatim}
